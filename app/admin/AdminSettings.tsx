...
export default function AdminSettings() {
  ...
  const [notifications, setNotifications] = useState({ transactions: true, kyc: true, disputes: true, withdrawals: true, support: true, security: true });
  ...
  function save() {
    localStorage.setItem(preferenceKey, JSON.stringify({ theme, language, currency, dateFormat, timezone, density, sidebarCollapsed, notifications }));
    setSaved(true);
