...
function HomeIcon() { return <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3.5 10.5 12 3l8.5 7.5"/><path d="M5.5 9.5v10h13v-10M9.5 19.5v-6h5v6"/></svg>; }
...
function BellIcon() { return <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M18 9a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9"/><path d="M10 21h4"/></svg>; }
...
export default function DashboardPage() {
  ...
  return <main className="safepay-shell safepay-dashboard">
    ...
    <nav className="sp-bottom-nav" aria-label="Navigation principale"><button className="active"><span><HomeIcon/></span><small>Accueil</small></button><button onClick={() => router.push("/transactions")}><span><TransactionsIcon/></span><small>Transactions</small></button><button onClick={() => router.push("/notifications")}><span><BellIcon/></span><small>Notifications</small></button><button onClick={() => router.push("/profile")}><span><ProfileIcon/></span><small>Profil</small></button></nav>
  </main>;
}
